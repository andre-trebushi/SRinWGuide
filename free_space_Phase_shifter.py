...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov  4 10:41:49 2022
...
und = Undulator(Kx=K/2, nperiods=1, lperiod=0.5, eid="und", phase=0, end_poles=0)
...
screen.end_energy =   THz*(1 + 15)*1e12*h_eV_s #0.12#10e12*h_eV_s      # [eV], ending photon energy
...
omega = np.linspace(omega_r*(1-0.9999), omega_r*(1+15), 501)
