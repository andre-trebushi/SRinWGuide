...
iris={'a' : 1, 'b' : 1, 'n_list' : n_list, 'k_list' : k_list}
f_5 = Green_func_integrand(x0, y0, z0, x, y, z, omega, ux, uy, uz, order=3, gradient_term=True, Green_func_type='iris', **iris)
...
n_list = [0]
k_0 = 1
k_list=np.arange(k_0, k_0 + 2000, 1)

iris={'a' : 2, 'b' : 2, 'n_list' : n_list, 'k_list' : k_list}
f = Green_func_integrand(x0, y0, z0, x, y, z, omega, ux, uy, uz, order=3, gradient_term=True, Green_func_type='iris', **iris)
...
screen.num_energy = 1  
screen = calculate_radiation(lat, screen, beam, energy_loss=False, quantum_diff=False, accuracy=0.25)
