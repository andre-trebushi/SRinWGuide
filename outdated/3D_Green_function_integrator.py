...
# -*- coding: utf-8 -*-
"""
Created on Thu May 19 13:43:07 2022
...
def gamma_z_integral(u_z, z, omega, order=1):
    I_array = np.array([])
    z_dz = np.roll(z, -1)[:-1]
...
screen.ny = 50    # number of points in vertical plane 
...
# ax1.plot(omega*1e-12/2/np.pi, I, label=r'Green func', linestyle='--', linewidth=1, color='blue')
ax1.pcolormesh(omega*1e-12/2/np.pi, y0, I[:, 0, :])
plt.show()