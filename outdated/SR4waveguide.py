...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  6 12:40:04 2022
...
ax2 = ax1.twinx() 
ax2.plot(omega*1e-12/2/np.pi, I, label=r'Green func', linestyle='--', linewidth=0.5, color='blue', alpha=0.8)
# ax1.plot(omega*h_eV_s/2/np.pi, I, label=r'Green func', linestyle='--', linewidth=1, color='blue')
# ax1.plot(omega*h_eV_s/2/np.pi, I_order2, label=r'Green func order $O(h^2)$', linestyle='--', linewidth=1, color='blue')
# ax1.plot(omega*h_eV_s/2/np.pi, I_order3, label=r'Green func order $O(h^3)$', linestyle='--', linewidth=1, color='orange')
# ax1.plot(omega*h_eV_s/2/np.pi, I_order4, label=r'Green func order $O(h^3)$', linestyle='--', linewidth=1, color='orange')

# ax2 = ax1.twinx() 
# ax1.plot(X, data, linewidth=1, color='black', linestyle='-', label='OCELOT')

# ax2.plot(X, abs((I_order2-data)/data), color='green', linewidth=1)
# ax2.plot(X, abs((I_order3-data)/data), color='red', linewidth=1)
# ax2.plot(X, abs((I_order4-data)/data), color='orange', linewidth=1)
# ax2.plot(X, 2*((I_order2-I_order3)/(I_order2+I_order3)), color='red', linewidth=1)
# ax2.plot(X, 2*((I_order3-I_order4)/(I_order3+I_order3)), color='orange', linewidth=1)

# ax2.plot(X, 2*(I_order1 - I_order2)/(I_order1 + I_order2), color='red', linewidth=1)
