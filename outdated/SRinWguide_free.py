...
def nubla_G(Green, x0, y0, z0, x, y, z, h='machine'):
    ...
    # G = G_free_space(x0, y0, z0, x, y, z, omega)
...
def Green_func_integrand(x0, y0, z0, x, y, z, omega, ux, uy, u_z, order=3, gradient_term=False, Green_func_type='free_space'):
    '''
    Parameters
    ----------
    z0 : array
    ...
    if Green_func_type=='free_space':
        ...
        Green = G_iris(x0, y0, z0, x, y, z, omega)
...
omega = np.linspace(omega_r*(1-0.9999), omega_r*(1+5), 1000)
