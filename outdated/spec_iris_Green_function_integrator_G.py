...
k_0 = 1
k_list=np.arange(k_0, k_0 + 1, 1)
# n_list = [0]
# k_list = [1]
# Green_nk = G(x0, y0, z0, x, y, z, omega, n_list=n_list, k_list=k_list)[1]
Green = G(x0, y0, z0, x, y, z, omega, n_list=n_list, k_list=k_list)[0]
...
X = screen.Eph
#%%
fig, ax1 = plt.subplots(figsize=(10, 5), num='MyName')

ax1.plot(omega/1e12/2/np.pi, I, linewidth=1, label='k = {}'.format(k_0))
